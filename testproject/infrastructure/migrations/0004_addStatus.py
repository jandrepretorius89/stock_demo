...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Facility.active'
        db.add_column(u'infrastructure_facility', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Facility.active'
        db.delete_column(u'infrastructure_facility', 'active')
